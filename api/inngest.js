...
function getStyleGuideForAge(age) {
  ...
  if (ageNum <= 7) {
    return "3D animated movie character — like Tangled, Brave, or Moana. Clearly a cartoon character, NOT a realistic portrait. Exaggerated large stylized eyes with oversized irises, bright catchlights, and thick lashes. Smooth clean skin with simple soft shading — no photorealistic texture, no painterly brushwork. Rounded cartoon face with exaggerated proportions. Vibrant saturated colors. Lush colorful storybook background filled edge to edge. The character radiates warmth and joy. Clean digital animation rendering — no realism, no oil paint, no portrait photography style. Pure Pixar/Disney animated film aesthetic.";
  } else if (ageNum <= 11) {
...
function getCoverStyleForAge(age) {
  const ageNum = parseInt(age) || 7;
  if (ageNum <= 7) {
    return "3D animated movie character — like Tangled, Brave, or Moana. Clearly a cartoon character, NOT a realistic portrait. Close-up portrait framing, character fills the frame from chest up. Exaggerated large stylized eyes with oversized irises, bright catchlights, and thick lashes. Smooth clean skin with simple soft shading — no photorealistic texture, no painterly brushwork, no oil paint. Rounded cartoon face with exaggerated proportions. Flowing voluminous hair with rich color. Vibrant saturated colors with warm lighting. Lush colorful storybook background filling the frame edge to edge. Clean digital animation rendering — no realism, no portrait photography style. Pure Pixar/Disney animated film aesthetic.";
  } else if (ageNum <= 11) {
