...
function getStyleGuideForAge(age) {
  ...
  if (ageNum <= 7) {
    return "Children's book illustration. Polished 2D digital cartoon art — NOT 3D CGI, NOT Pixar rendered, NOT photorealistic. Big expressive 2D cartoon eyes with bright catchlights. Smooth cel-shaded skin with soft clean gradients. Vibrant saturated colors. Rich detailed background scene filling the frame edge to edge. The character radiates warmth and joy. Style reference: polished children's book illustration or mobile game character art. Pure 2D digital illustration — no 3D rendering, no painterly texture, no photorealism.";
  } else if (ageNum <= 11) {
...
function getCoverStyleForAge(age) {
  const ageNum = parseInt(age) || 7;
  if (ageNum <= 7) {
    return "Children's book cover illustration. Polished 2D digital cartoon art — NOT 3D CGI, NOT Pixar rendered, NOT photorealistic. Character shown from the waist up, centered in a vibrant storybook scene. Big expressive 2D cartoon eyes with bright catchlights. Smooth cel-shaded skin with soft clean gradients. Flowing voluminous hair with rich color and shine. Warm saturated colors. Rich detailed background scene filling the frame edge to edge — sky, nature, and setting-appropriate elements. The character radiates warmth and joy. Style reference: polished children's book cover art or mobile game character illustration. Pure 2D digital illustration — no 3D rendering, no painterly texture, no photorealism.";
  } else if (ageNum <= 11) {
